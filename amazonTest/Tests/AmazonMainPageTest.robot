...
Verify user is able to naviage to the Amazon main page
    ...
    [Tags]                              TC_MP_001   Smoke   Regression   MainPage
...
Verify user is able to click on Main Menu
    ...
    [Tags]                              TC_MP_002   Smoke   Regression   MainPage
    Page Load By Global User
    Click Main Menu
